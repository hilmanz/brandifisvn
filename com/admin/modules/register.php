...
class register extends App{
	...
	function main(){
		...
		return $this->View->toString(TEMPLATE_DOMAIN_ADMIN .'apps/register-user-lists.html');
	...
	if ($this->_p('submit')){
		...
		return $this->View->toString(TEMPLATE_DOMAIN_ADMIN .'apps/create-user.html');
	...
	function registeredit()
	{
		...
		return $this->View->toString(TEMPLATE_DOMAIN_ADMIN .'apps/register-edit.html');
	}
	...
	function edit(){
		...
		return $this->View->toString(TEMPLATE_DOMAIN_ADMIN .'apps/edit-user.html');
	}
